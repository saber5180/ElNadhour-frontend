...
const LivePopup = () => {
  ...
  return (
    <>
      {/* Modern Notification Style Popup */}
      <div className="fixed top-6 right-6 z-50 animate-live-popup-in max-w-xs">
        <div className="bg-white rounded-2xl shadow-xl border border-gray-100">
          ...
          <div className="flex items-center justify-between p-4 pb-2">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs text-gray-500">• {liveData.viewer_count || 0} watching</span>
            </div>
            <button
              onClick={handleClose}
          ...
          <div className="px-4 pb-4">
            <div className="flex items-start space-x-3">
              {/* Logo/Stream Preview */}
              <div className="w-10 h-10 bg-[#1F5A6B] rounded-full flex items-center justify-center flex-shrink-0 mt-1 relative overflow-hidden">
                {liveData.stream_url === 'camera-live' ? (
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-pink-500 via-purple-600 to-orange-400 flex items-center justify-center">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <img src="/icon.png" alt="El Nadhour" className="w-6 h-6" />
                )}
              </div>
